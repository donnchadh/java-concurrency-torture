...
import net.shipilev.concurrent.torture.api.TwoActorsOneArbiterTest;
 ...
 */
public class AtomicIntegerIncDecTest implements TwoActorsOneArbiterTest<AtomicInteger> {
